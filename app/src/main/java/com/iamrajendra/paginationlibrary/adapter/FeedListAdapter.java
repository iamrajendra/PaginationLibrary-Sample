package com.iamrajendra.paginationlibrary.adapter;
...
import com.iamrajendra.paginationlibrary.databinding.FeedItemBinding;
import com.iamrajendra.paginationlibrary.databinding.NetworkItemBinding;
...
public class FeedListAdapter extends PagedListAdapter<Article, RecyclerView.ViewHolder> {
    ...
    public class ArticleItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTo(Article article) {
            ...
            Picasso.get().load(article.getUrlToImage()).resize(250, 200).into(binding.image);
        }
    }
